...
// const myBirth=new Date(1987,11,27,17,0,0,0);
// const anotherDate=new Date('1987-12-27T17:00:00');
//
// today.getTimezoneOffset();
// today.getDate();
// today.getHours();
// const str=today.getFullYear().String();
// today.getUTCHours();
// today.getUTCMonth();
// today.setHours(5);
// today.setMonth(5);
...
const array=new Array(30000000);
array.fill({id:Math.random(),name:'Anatolii'});
array.filter(({id})=>{
    return id<0.023456;
}).map(({name,id})=>{
    return `${name}${id}`
